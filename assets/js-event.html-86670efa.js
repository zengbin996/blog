import{_ as a,M as t,p as i,q as l,R as n,t as o,N as c,a1 as e}from"./framework-e0dd9823.js";const d={},u=e(`<h1 id="javascript-事件" tabindex="-1"><a class="header-anchor" href="#javascript-事件" aria-hidden="true">#</a> JavaScript 事件</h1><p>事件是可以被 JavaScript 侦测到的行为。</p><h3 id="事件类型" tabindex="-1"><a class="header-anchor" href="#事件类型" aria-hidden="true">#</a> 事件类型</h3><ul><li>鼠标事件</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>onclick<span class="token punctuation">;</span> <span class="token comment">//单击</span>
