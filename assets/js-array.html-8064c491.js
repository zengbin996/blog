import{_ as a,p as r,q as i,t as n,a1 as e}from"./framework-e0dd9823.js";const d={},l=e(`<h1 id="javascript-数组" tabindex="-1"><a class="header-anchor" href="#javascript-数组" aria-hidden="true">#</a> JavaScript 数组</h1><p>数组可以用来存储一组有序的数据集合，数组里面可以存放任意数据类型的数据。</p><h4 id="创建数组" tabindex="-1"><a class="header-anchor" href="#创建数组" aria-hidden="true">#</a> 创建数组</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>//方式一 字面量创建
var arr = [];
