import{_ as i,p as e,q as n,a1 as l}from"./framework-e0dd9823.js";const d={},s=l(`<h1 id="网页常用布局方式" tabindex="-1"><a class="header-anchor" href="#网页常用布局方式" aria-hidden="true">#</a> 网页常用布局方式</h1><h4 id="两列布局-左边固定-右边自适应" tabindex="-1"><a class="header-anchor" href="#两列布局-左边固定-右边自适应" aria-hidden="true">#</a> 两列布局（左边固定，右边自适应）</h4><p><img src="https://upload-images.jianshu.io/upload_images/19038988-c188a4a94090ef3a.png?imageMogr2/auto-orient/strip|imageView2/2/w/1240" alt="两列布局"></p><p>html 结构</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;div class=&quot;box&quot;&gt;
