...
- 青木：お忙しいところ、すみません。実は、上海支社で進めている「金星」プロジェクトが、思ったよりたいへんな仕事になりそうなんです。
- 山田：そうですか。
...
| こくないりょうこう       | 国内旅行       | 国内旅行                   |
| でんきせいひん           | 電気製品       | 电器                       |
| ユーターンげんしょう     | U ターン現象   | 掉头现象                   |
| アイターンげんしょう     | I ターン現象   | 单行现象                   |
| ～だい                   | ～代           | ~多岁                      |
| ～ご                     | ～後           | ~之后                      |
| ～か                     | ～家           | ~家                        |
