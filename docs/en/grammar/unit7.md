...
时间副词的作用就是做时间状语，一般放在句尾。注意，每一个时间副词表示了不同的时间概念，所以对时态有着严格的要求。以下分开讲解每一个时间副词的用法。
...
here / there / downstairs / upstairs / nearby / outside / abroad / around / everywhere / indoors / outdoors / anywhere
