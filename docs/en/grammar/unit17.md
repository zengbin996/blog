...
其实，whom 作为疑问词已经差不多淘汰了，现代英语已经很少用了，基本都用 who。当然，whom 做定语从句的连接词还是很常见的。
...
how long 做时间状语，主要用于现在完成时态第一种用法，必须使用延续性动词，句型如下：
