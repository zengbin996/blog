...
可数名词就是那些肉眼可以分清数量的名词，比如书、房子、手机、电脑；不可数名词刚好相反，就是那些肉眼无法区分数量或者很难区分数量的名词，例如大部分的液体：水、茶、酒、牛奶，还有头发、大米、沙子也是不可数名词。

有时候，可数和不可数跟中文里面不一样。例如：“天空”，英文“sky”是可数的，复数形式是“skies”，一般我们认为，天空是只有一个的，但在英语里面的确是可数名词。同样是液体，“water”是不可数名词，“tear”却是可数名词。类型的例子还有很多，我们在使用的时候要多积累，遇见不会的名词，查字典即可。
...
1. two cups of tea
2. a bottle of milk
3. a kilogram of meat

量词构成方式：

a/an/one + 可数名词单数 + of ， 例如： a cup of 、 a bucket of

数词 + 可数名词复数 + of ，例如：two bottles of 、three tins of（三罐）
